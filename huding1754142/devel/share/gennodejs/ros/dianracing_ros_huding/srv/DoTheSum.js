...
// (in-package dianracing_ros_huding.srv)
...
class DoTheSumRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DoTheSumRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DoTheSumRequest
    let len;
    let data = new DoTheSumRequest(null);
  ...
  static datatype() {
    ...
    return 'dianracing_ros_huding/DoTheSumRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DoTheSumRequest(null);
    if (msg.a !== undefined) {
      resolved.a = msg.a;
    }
    else {
...
class DoTheSumResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DoTheSumResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DoTheSumResponse
    let len;
    let data = new DoTheSumResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DoTheSumResponse(null);
...
module.exports = {
  Request: DoTheSumRequest,
  Response: DoTheSumResponse,
  md5sum() { return 'c9caccfcada3b6a45d8528a23bccaf1a'; },
  datatype() { return 'dianracing_ros_huding/DoTheSum'; }
};
