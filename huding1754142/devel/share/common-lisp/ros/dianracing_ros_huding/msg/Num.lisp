...
(cl:in-package dianracing_ros_huding-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dianracing_ros_huding-msg:<Num> is deprecated: use dianracing_ros_huding-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dianracing_ros_huding-msg:num-val is deprecated.  Use dianracing_ros_huding-msg:num instead.")
  (num m))
